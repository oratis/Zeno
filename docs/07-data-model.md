...
**议题：统一商品模型（同款合并）+ 知识图谱 + 佣金不入排序，值得吗？**

**🟦 正方（支持）**
- 同款合并支撑"跨平台比到手价"——这是货架做不到、用户最想要的核心价值。
- 佣金不入排序把中立制度化；知识图谱支撑场景 / 平替 / 兼容推理。

**🟥 反方（质疑）**
- 跨平台同款识别（无统一 GTIN、标题脏）准确率难保证，错合并直接砸比价信任。
- 知识图谱构建与维护成本极高，易成"重而无用"。
- "佣金不入排序"牺牲短期收入，商业压力下承诺可能被悄悄侵蚀。

**⚖️ 裁决**
- 同款合并设置置信阈值，低置信宁可不合并、分开展示。
- 知识图谱从窄品类本体起步、增量扩，不追求一步到位。
- 用治理 + 审计硬锁"佣金不入排序"，使其不可被产品 / 商业单方面绕过。
- **Kill 信号：** 同款误合并率高到用户投诉比价不准；或中立承诺在商业压力下无法坚持。
